...
public class FunSizeCandyTest {
  ...
  public void testEquals() {
    ICandy candy1 = generator.generateCandy("Fun",
        new Candy.CandyType[] {Candy.CandyType.Twix, Candy.CandyType.Mars});
    ICandy candy2 = generator.generateCandy("Fun",
        new Candy.CandyType[] {Candy.CandyType.Twix, Candy.CandyType.Mars});
  ...
  public void testNotEquals() {
    ICandy candy1 = generator.generateCandy("Fun", "Twix");
    ICandy candy2 = generator.generateCandy("Fun",
        new Candy.CandyType[] {Candy.CandyType.Twix, Candy.CandyType.Mars});
